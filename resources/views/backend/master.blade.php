  ...
  <body>
      ...
      <div class="sl-sideleft-menu">
        ...
        <a href="#" class="sl-menu-link">
          ...
          <ul class="sl-menu-sub nav flex-column">
            ...
            <li class="nav-item"><a href="{{ url('subcategory-add') }}" class="nav-link">Add Sub-Category</a></li>
            <li class="nav-item"><a href="{{ url('subcategory-view') }}" class="nav-link">View Sub-Category</a></li>
          </ul>

          <a href="{{ url('attributes') }}" class="sl-menu-link">
            <div class="sl-menu-item">
          ...
          <a href="{{ route('Orders') }}" class="sl-menu-link">
            <div class="sl-menu-item">
              <i class="fa fa-dollar tx-20"></i>
              <span class="menu-item-label">Orders</span>
            </div><!-- menu-item -->
          </a><!-- sl-menu-link -->

          <a href="{{ route('RoleManager') }}" class="sl-menu-link">
            <div class="sl-menu-item">
          ...
          <ul class="sl-menu-sub nav flex-column">
            ...
            <li class="nav-item"><a href="#" class="nav-link">View Blog</a></li>
          </ul>
    ...
    <div class="sl-mainpanel">
      <nav class="breadcrumb sl-breadcrumb">
        <a class="breadcrumb-item" href="{{ url('/') }}">Admin Panel</a>
